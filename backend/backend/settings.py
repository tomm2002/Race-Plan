...
load_dotenv() #for credentials off the database
...
ALLOWED_HOSTS = ["*"] #anyone can host our app -> for deployment
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("DATA_BASE_PWD"),
...
gitgALLOWED_HOSTS = ['*'] #wild card for any host
